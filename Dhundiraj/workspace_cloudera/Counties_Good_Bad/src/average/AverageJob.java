...
public class AverageJob extends Configured implements Tool {
	...
	public enum Counters {MAP, COMBINE, REDUCE,GOOD,BAD}
	...
	public static class AverageMapper extends Mapper<LongWritable, Text, Text, Text> {
		...
		protected void cleanup(Context context)
			...
			System.out.println("MAP counter = " + context.getCounter(Counters.GOOD).getValue());
			System.out.println("MAP counter = " + context.getCounter(Counters.BAD).getValue());
		}
	}
	...
	public int run(String[] arg0) throws Exception {
		...
		FileInputFormat.setInputPaths(job, "counties_modified");
